...
public class OclickService extends Service implements
    ...
    private static final String SERVICE_NOTIF_CHANNEL = "service";
    ...
    public void onCreate() {
        ...
        mRingtone = RingtoneManager.getRingtone(this, toneUri);
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        ...
        if (key.equals(PreferenceKeys.FENCE)) {
            toggleRssiListener();
        } else if (key.equals(PreferenceKeys.DISCONNECT_ALERT)) {
            updateLinkLossState();
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (mBluetoothDevice == null && mPrefs.contains(PreferenceKeys.DEVICE_ADDRESS)) {
    ...
    private void toggleRssiListener() {
        ...
        mRssiAlertEnabled = prefs.getBoolean(PreferenceKeys.FENCE, true);
        mHandler.removeMessages(MSG_POLL_RSSI);
        if (mRssiAlertEnabled) {
    ...
    private void updateLinkLossState() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        boolean alert = prefs.getBoolean(PreferenceKeys.DISCONNECT_ALERT, true);
    ...
    private void createNotificationChannel() {
        ...
        final NotificationChannel channel = new NotificationChannel(SERVICE_NOTIF_CHANNEL,
    ...
    private void updateNotification() {
        ...
        final Notification.Builder builder = new Notification.Builder(this, SERVICE_NOTIF_CHANNEL)
